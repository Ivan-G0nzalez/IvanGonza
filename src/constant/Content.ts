...
export const content = {
  ...
  skills: {
    ...
    skills_content: [
      {
        name: "Postgres",
        para: "Fundamentals skills on Postgres",
        logo: postgres,
      },
      {
        name: "Node js",
        para: "Fundamentals skills on Node js",
        logo: nodejs,
      },
      {
        name: "AWS",
        para: "Fundamentals skills on AWS",
        logo: aws,
      },
      {
        name: "React",
        para: "Fundamentals skills on React",
        logo: reactjs,
      },
      {
        name: "Tailwind",
        para: "Fundamentals skills on Tailwind",
        logo: tailwind,
      },
      {
        name: "Python",
        para: "Fundamentals skills on Python",
        logo: python,
      },
    ],
    icon: MdArrowForward,
